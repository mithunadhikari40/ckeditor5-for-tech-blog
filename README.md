...
### Note: This branch does not have inline title section. If you need that, please use the main branch instead.
## Quick start

1. Open the `sample/index.html` page in the browser. Sample image is attached here in the repo, you can open that image to see how the layout will look. `sample_pic.png`
...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `6ymwu6ye584n-n7xko4a9684y`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
